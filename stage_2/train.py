...
from model_components import svadVLM_LoRA, count_parameters, NextTokenLoss
...
def main():
    ...
    loss_function = NextTokenLoss(vocab_size=vocab_size, loss_gen_type="token", loss_gen_factor=1.0)
    ...
    torch.save(model.state_dict(), 'Output_23/model.pth')
